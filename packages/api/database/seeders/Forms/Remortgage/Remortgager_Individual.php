...
class Remortgager_Individual extends Seeder
{
    ...
    public function run()
    {
        ...
        $form = Form::factory()
            ->state([
                'name' => 'Remortgager Form (Individual)',
                'group' => FormGroup::GettingStarted,
                'description' => 'This section aims to gather information about the remortgager(s) and whether the property is being remortgaged by them or on their behalf.',
    ...
    public function theRemortgager(Form $form)
    {
        ...
        $remortgagerSection = $form->sections()->create([
            'name' => 'Remortgager Section',
        ]);

        // 1.1 Start of Buyer Status step
        $remortgagerStatusStep = $remortgagerSection->steps()->create([
            'question' => 'Please select the status of the above remortgager:',
            'help_text' => ''
                .'<p>Remortgagers may be buying the property as themselves or in certain circumstances have someone buying on their behalf.</p>'
                ."<p>If the remortgager is buying the property as themselves, select 'Remortgaging as themselves'.</p>"
                ."<p>If the owner has an attorney dealing with the sale, select 'Remortgaging via attorney'.</p>"
                ."<p>If the owner has a deputy dealing with the sale, select 'Remortgaging via deputy'</p>",
        ]);

        $remortgagerStatusAnswer = $remortgagerStatusStep->answers()->create([
            'type' => AnswerType::SingleSelect,
            'details' => [
                'options' => [
                    ['value' => 'Remortgaging as themselves'], // End form
                    ['value' => 'Remortgaging via attorney'], // Load section 2.1
                    ['value' => 'Remortgaging via deputy'], // Load section 3.1
                ],
                'pdfFormFieldName' => OverviewPdfField::Representation,
            ],
        ]);

        $this->globalBuyerStatusAnswer = $remortgagerStatusAnswer;

        $remortgagerStatusAnswer->validationRules()->create([
            'rule' => 'required',
        ]);
        // End ---
    }
    ...
    public function thePowerOfAttorney(Form $form)
    {
        ...
        $powerOfAttorneySection->conditions()->create([
            ...
            'selected_value' => 'Remortgaging via attorney',
        ]);

        // 2.1 Start of attorney quantity section
        $attorneyQuantityStep = $powerOfAttorneySection->steps()->create([
            'question' => 'Please confirm the number of attorneys acting for the above remortgager:',
        ...
        $attorneyTeamStatusStep = $powerOfAttorneySection->steps()->create([
            ...
            'help_text' => ''
                .'<p>SEVERALLY: all attorneys are required for any decision. If jointly is selected we will require the names of all the attorneys. All attorneys will then be invited to PreConvey to confirm your replies to the forms.</p>'
                .'<p>JOINTLY: an attorney can act alone in making decisions. If severally is selected you can complete the forms alone and do not need to enter the names of the other attorneys.</p>',
        ]);
        ...
        $attorneyDetailsSeverallyStep = $powerOfAttorneySection->steps()->create([
            ...
            'question' => 'Please enter the details of each attorney for the above remortgager:',
        ...
        $attorneyDetailsJointlyStep = $powerOfAttorneySection->steps()->create([
            'type' => StepType::Attorney,
            'question' => 'Please enter the details of the attorney who will be completing the sale on behalf of the above remortgager:',
        ...
        $presentPowerOfAttorneyStep = $powerOfAttorneySection->steps()->create([
            'question' => 'Is there a Power of Attorney already in place for the above remortgager?',
    ...
    public function theDeputyshipOrder(Form $form)
    {
        ...
        $powerOfDeputySection->conditions()->create([
            'answer_id' => $this->globalBuyerStatusAnswer->id,
            'selected_value' => 'Remortgaging via deputy',
        ]);

        // 3.1 Start of deputy quantity section
        $deputyQuantityStep = $powerOfDeputySection->steps()->create([
            'question' => 'Please confirm the number of deputies acting for the above remortgager:',
        ...
        $deputyTeamStatusStep = $powerOfDeputySection->steps()->create([
            ...
            'help_text' => ''
                .'<p>SEVERALLY: all deputies are required for any decision. If jointly is selected we will require the names of all the deputies. All deputies will then be invited to PreConvey to confirm your replies to the forms.</p>'
                .'<p>JOINTLY: a deputy can act alone in making decisions. If severally is selected you can complete the forms alone and do not need to enter the names of the other deputies.</p>',
        ]);
        ...
        $deputyDetailsSeverallyStep = $powerOfDeputySection->steps()->create([
            ...
            'question' => 'Please enter the details of each deputy for the above remortgager:',
        ...
        $deputyDetailsJointlyStep = $powerOfDeputySection->steps()->create([
            'type' => StepType::Deputy,
            'question' => 'Please enter the details of the deputy who will be completing the Purchase on behalf of the above remortgager:',
        ...
        $presentPowerOfDeputyStep = $powerOfDeputySection->steps()->create([
            'question' => 'Is there a Deputyship Order already in place for the above remortgager?',
