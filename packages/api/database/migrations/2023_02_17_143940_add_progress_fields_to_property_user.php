...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('property_user', function (Blueprint $table) {
            $table->timestamp('client_care_letter_completed_at')->nullable();
            $table->timestamp('terms_and_conditions_completed_at')->nullable();
            $table->timestamp('id_checks_completed_at')->nullable();
        });
    }
