...
class Giftors extends Component
{
    ...
    public function render()
    {
        switch ($this->property->type) {
            ...
            case PropertyType::Purchase:
                if (Arr::get($this->details, 'giftors') === null) {
                    return null;
                }

                return view('components.pdf-overview.purchase-funds.giftors', [
                    'property' => ($this->property),
                    'giftors' => Arr::get($this->details, 'giftors', '-'),
                ]);
                break;
        }
    }
